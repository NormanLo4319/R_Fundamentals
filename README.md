...
To start coding in R, we only need to open RStudio because it automatically run the R software in the background for us.  The interface in RStudio is very intuitive to use and here is a picture to explain:
