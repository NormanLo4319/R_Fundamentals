# R_Fundermentals
In this repository, we explore the R fundamentals and learn how to program with R.  We use the Integrated Development Environment, IDEs, ["R Studio"](https://rstudio.com/) in this project. We include the installation instructions below before we start to code in R.
...
To start coding in R, we only need to open RStudio because it automatically runs the R software in the background and execute the code.  The interface in RStudio is very intuitive to use and here is a picture to explain:
